...
SOUND_MCHAR_YAH_WAH_HOO                  (0x24008080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x00, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
SOUND_MCHAR_HOOHOO                       (0x24038080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x03, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
SOUND_MCHAR_YAHOO                        (0x24048080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x04, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
SOUND_MCHAR_UH                           (0x24058080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x05, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
SOUND_MCHAR_HRMM                         (0x24068080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x06, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
SOUND_MCHAR_WAH2                         (0x24078080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x07, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
SOUND_MCHAR_WHOA                         (0x2408C080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x08, 0xC0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
SOUND_MCHAR_EEUH                         (0x24098080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x09, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
SOUND_MCHAR_ATTACKED                     (0x240AFF80), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x0A, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
SOUND_MCHAR_OOOF                         (0x240B8080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x0B, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
SOUND_MCHAR_OOOF2                        (0x240BD080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x0B, 0xD0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
SOUND_MCHAR_HERE_WE_GO                   (0x240C8080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x0C, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
SOUND_MCHAR_YAWNING                      (0x240D8080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x0D, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
SOUND_MCHAR_SNORING1                     (0x240E8080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x0E, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
SOUND_MCHAR_SNORING2                     (0x240F8080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x0F, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
SOUND_MCHAR_WAAAOOOW                     (0x2410C080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x10, 0xC0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
SOUND_MCHAR_HAHA                         (0x24118080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x11, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
SOUND_MCHAR_HAHA_2                       (0x2411F080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x11, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
SOUND_MCHAR_UH2                          (0x2413D080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x13, 0xD0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
SOUND_MCHAR_UH2_2                        (0x24138080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x13, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
SOUND_MCHAR_ON_FIRE                      (0x2414A080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x14, 0xA0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
SOUND_MCHAR_DYING                        (0x2415FF80), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x15, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
SOUND_MCHAR_PANTING_COLD                 (0x24168080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x16, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

// A random number 0-2 is added to the sound ID before playing
SOUND_MCHAR_PANTING                      (0x24188080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x18, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

SOUND_MCHAR_COUGHING1                    (0x241B8080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x1B, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
SOUND_MCHAR_COUGHING2                    (0x241C8080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x1C, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
SOUND_MCHAR_COUGHING3                    (0x241D8080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x1D, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
SOUND_MCHAR_PUNCH_YAH                    (0x241E8080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x1E, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
SOUND_MCHAR_PUNCH_HOO                    (0x241F8080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x1F, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
SOUND_MCHAR_MAMA_MIA                     (0x24208080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x20, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
SOUND_MCHAR_OKEY_DOKEY                   (0x20210000), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x21, 0x00, 0) // unused
SOUND_MCHAR_GROUND_POUND_WAH             (0x24228080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x22, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
SOUND_MCHAR_DROWNING                     (0x2423F080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x23, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
SOUND_MCHAR_PUNCH_WAH                    (0x24248080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x24, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

    /* MChar Sound Effects (US/EU only) */
SOUND_PEACH_DEAR_MCHAR                   (0x2428FF80), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x28, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

// A random number 0-4 is added to the sound ID before playing, producing one of
// Yahoo! (60% chance), Waha! (20%), or Yippee! (20%).
SOUND_MCHAR_YAHOO_WAHA_YIPPEE            (0x242B8080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x2B, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

SOUND_MCHAR_DOH                          (0x24308080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x30, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
SOUND_MCHAR_GAME_OVER                    (0x2431FF80), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x31, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
SOUND_MCHAR_HELLO                        (0x2432FF80), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x32, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
SOUND_MCHAR_PRESS_START_TO_PLAY          (0x2433FFA0), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x33, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_NO_ECHO | SOUND_DISCRETE)
SOUND_MCHAR_TWIRL_BOUNCE                 (0x24348080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x34, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
SOUND_MCHAR_SNORING3                     (0x2435FF80), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x35, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
SOUND_MCHAR_SO_LONGA_BOWSER              (0x24368080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x36, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
SOUND_MCHAR_IMA_TIRED                    (0x24378080), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x37, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

    /* Princess Peach Sound Effects (US/EU only) */
SOUND_PEACH_MCHAR                        (0x2438FF80), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x38, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
SOUND_PEACH_THANK_YOU_MCHAR              (0x243BFF80), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x3B, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
SOUND_PEACH_FOR_MCHAR                    (0x243EFF80), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x3E, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
SOUND_PEACH_MCHAR2                       (0x243FFF80), //  SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x3F, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
//#ifdef VERSION_JP
//SOUND_GENERAL_PAINTING_EJECT             (0x38280080), //  SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x28, 0x00, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
//#else
...
//SOUND_GENERAL_COIN_SPURT                 (0x30300080), //  SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x30, 0x00, SOUND_DISCRETE) // unverified
...
//#else
//        SOUND_GENERAL_COIN_SPURT                 (0x38302080), //  SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x30, 0x20, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE) // unverified
//#endif
...
//#ifdef VERSION_JP
//SOUND_GENERAL_UNKNOWN3                   (0x30370080), //  SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x37, 0x00, SOUND_DISCRETE) // unverified
//#else
...
//#ifdef VERSION_JP
//SOUND_GENERAL_UNK46                      (0x30460080), //  SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x46, 0x00, SOUND_DISCRETE) // unverified
//#else
...
//#ifdef VERSION_JP
//SOUND_MENU_PAUSE                         (0x7002F080), //  SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x02, 0xF0, SOUND_DISCRETE)
//#else
...
SOUND_MENU_PINCH_MCHAR_FACE              (0x70080080), //  SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x08, 0x00, SOUND_DISCRETE)
SOUND_MENU_LET_GO_MCHAR_FACE             (0x70090080), //  SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x09, 0x00, SOUND_DISCRETE)
...
SOUND_MENU_COIN_ITS_A_ME_MCHAR           (0x70140080), //  SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x14, 0x00, SOUND_DISCRETE)
...
SOUND_MENU_MCHAR_CASTLE_WARP             (0x701DB080), //  SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x1D, 0xB0, SOUND_DISCRETE) // unverified
...
SOUND_MENU_MCHAR_CASTLE_WARP2            (0x70222080), //  SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x22, 0x20, SOUND_DISCRETE) // unverified
