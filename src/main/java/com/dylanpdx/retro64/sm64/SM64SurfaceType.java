...
public class SM64SurfaceType {
     public static final byte Default = 0x0000; // Environment default
     public static final byte Burning = 0x0001; // Lava / Frostbite (in SL), but is used mostly for Lava
     public static final byte Hangable = 0x0005; // Ceiling that MChar can climb on
     public static final byte Slow = 0x0009; // Slow down MChar, unused
     public static final byte VerySlippery = 0x0013; // Very slippery, mostly used for slides
     public static final byte Slippery = 0x0014; // Slippery
     public static final byte NotSlippery = 0x0015; // Non-slippery, climbable
     public static final byte ShallowQuicksand = 0x0021; // Shallow Quicksand (depth of 10 units)
     public static final byte DeepQuicksand = 0x0022; // Quicksand (lethal, slow, depth of 160 units)
     public static final byte InstantQuicksand = 0x0023; // Quicksand (lethal, instant)
     public static final byte Ice = 0x002E; // Slippery Ice, in snow levels and THI's water floor
     public static final byte Hard = 0x0030; // Hard floor (Always has fall damage)
     public static final byte HardSlippery = 0x0035; // Hard and slippery (Always has fall damage)
     public static final byte HardVerySlippery = 0x0036; // Hard and very slippery (Always has fall damage)
     public static final byte HardNotSlippery = 0x0037; // Hard and Non-slippery (Always has fall damage)
     public static final byte VerticalWind = 0x0038; // Death at bottom with vertical wind
/*
